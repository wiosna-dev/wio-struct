...
class WioStruct
{
    ...
    */
    ...
    /*
        Links table
    */
    private function getLinkId($parentId,$childrenId)
    {
    ...
    private function generateAutoLinks($parentId,$nodeId) # to fix
    {
    ...
    private function removeAutoLinks($nodeId) # to fix
    {
    ...
    */
    ...
    public function getNodesWithFlags($nodesSettings,$parentSettings)
    {
